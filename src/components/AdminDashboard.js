...
const StatCard = ({ label, value, icon }) => (
  ...
  >
    <Stack direction="row" spacing={1.5} alignItems="center">
      <Avatar sx={{ bgcolor: "rgba(19,99,223,0.1)", color: "primary.main" }}>{icon}</Avatar>
      <Box>
              ...
              <Box sx={{ width: '100%', height: 260 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <RechartsTooltip 
                      cursor={{ fill: 'rgba(19,99,223,0.04)' }}
            ...
            <Paper sx={{ p: 3, borderRadius: 4, bgcolor: "background.paper" }} elevation={0}>
              ...
              <Stack spacing={1.5}>
                {stats.recentDoctors.map((doctor) => (
                  <Paper key={doctor._id} sx={{ p: 1.5, borderRadius: 3, bgcolor: "rgba(19,99,223,0.04)" }} elevation={0}>
            ...
            <Paper sx={{ p: 3, borderRadius: 4, bgcolor: "background.paper" }} elevation={0}>
              ...
              <Stack spacing={1.5}>
                {stats.recentAppointments.map((appointment) => (
                  <Paper key={appointment._id} sx={{ p: 1.5, borderRadius: 3, bgcolor: "rgba(19,99,223,0.04)" }} elevation={0}>
            ...
            <Paper sx={{ p: 3, borderRadius: 4, bgcolor: "background.paper" }} elevation={0}>
              ...
              <Stack spacing={1.5}>
                {stats.recentMessages.map((message) => (
                  <Paper key={message._id} sx={{ p: 1.5, borderRadius: 3, bgcolor: "rgba(19,99,223,0.04)" }} elevation={0}>
                    <Typography sx={{ fontWeight: 800 }}>
